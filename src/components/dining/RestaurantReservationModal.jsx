...
import { X, Clock, Users, DollarSign, Calendar, Check } from 'lucide-react';
import DatePicker from 'react-datepicker';
import 'react-datepicker/dist/react-datepicker.css';

const RestaurantReservationModal = ({ restaurant, isOpen, onClose }) => {
    ...
    const generateTimeSlots = () => {
        const slots = [];
        const hours = restaurant.hours.split(' - ');
        const startHour = parseInt(hours[0]);
        const endHour = parseInt(hours[1]) || 22;
                            ...
                            <div className="max-h-[85vh] overflow-y-auto">
                                ...
                                <div className="relative h-48 md:h-56">
                                    ...
                                    <div className="absolute bottom-4 left-4 right-4 text-white">
                                        <span className="inline-block bg-primary-500 text-white text-sm px-3 py-1 rounded-full mb-2">
                                            {restaurant.cuisine}
                                        </span>
                                ...
                                <div className="p-6 md:p-8">
                                    ...
                                    <p className="text-neutral-600 mb-6">{restaurant.description}</p>
...
export default RestaurantReservationModal;
